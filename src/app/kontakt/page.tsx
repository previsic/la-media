    ...
    <div ref={ref}>
      ...
      <section className="bg-[#f8f9fa] py-16 md:py-20 px-6 md:px-16 lg:px-24">
        <div className="max-w-2xl">
          <h2 className="text-2xl md:text-3xl font-bold text-[#111] mb-4">Posjetite nas</h2>
          <p className="text-[#555] text-base leading-relaxed">
            Nalazimo se u ulici Kralja Zvonimira 13, Mostar. Dođite na kavu i dogovorimo suradnju!
          </p>
        </div>
      </section>
    </div>
